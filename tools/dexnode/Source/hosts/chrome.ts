...
export const HOST_CHROME_STABLE: Host<"chrome"> = {
	flagName: "chrome",
	flags: HostFlags.ChromiumArguments | HostFlags.UseLatestV8Version,
	paths: {
		win32: [
			"chrome",
...
export const HOST_CHROME_DEV: Host<"chrome_dev"> = {
	...
	paths: {
		...
		linux: ["google-chrome-dev", "/usr/bin/google-chrome-dev"],
	},
	registry: [
		{
...
export const HOST_CHROME_BETA: Host<"chrome_beta"> = {
	...
	paths: {
		...
		linux: ["google-chrome-beta", "/usr/bin/google-chrome-beta"],
	},
	registry: [
		{
	...
	paths: {
		win32:
			process.platform === "win32" && process.env.LOCALAPPDATA
				...
				: undefined,
		darwin: [], // TODO
		linux: ["google-chrome-canary", "/usr/bin/google-chrome-canary"],
	},
	registry: [],
};
