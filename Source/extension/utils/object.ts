...
export type TypeSafeEntries<T extends object> = Extract<
	{ [P in Extract<keyof T, string>]: [P, T[P]] }[Extract<keyof T, string>],
	[string, any]
>[];
...
export type TypeSafeDefinedEntries<T extends object> = Extract<
	{
		[P in Extract<keyof T, string>]-?: [P, Exclude<T[P], undefined>];
