...
function createEvents() {
	return EVENTMAP({
		...
		willChangeCurrentProfileViewNodeSnapshot: new EventEmitter<
			ProfileViewNodeSnapshot | undefined
		>(),
		didChangeCurrentProfileViewNodeSnapshot: new EventEmitter<
			ProfileViewNodeSnapshot | undefined
		>(),
		...
		didShowDecorationsChange: new EventEmitter<
			ImmutableEnumSet<ShowDecorations>
		>(),
		...
		didShowICStatesChange: new EventEmitter<
			ImmutableEnumSet<ShowICStates>
		>(),
...
function EVENTMAP<A extends Record<string, EventEmitter<any>>>(
	map: A,
): EVENTMAP<A> {
