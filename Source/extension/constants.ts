...
export namespace commands {
	...
	export namespace functions {
		...
		export const showFunctionHistory =
			`${functions}.showFunctionHistory` as const;
	}
	...
	export namespace ics {
		...
		export const showStateMegamorphic =
			`${ics}.showStateMegamorphic` as const;
		export const showStatePolymorphic =
			`${ics}.showStatePolymorphic` as const;
		export const showStateMonomorphic =
			`${ics}.showStateMonomorphic` as const;
		...
		export const hideStateMegamorphic =
			`${ics}.hideStateMegamorphic` as const;
		export const hideStatePolymorphic =
			`${ics}.hideStatePolymorphic` as const;
		export const hideStateMonomorphic =
			`${ics}.hideStateMonomorphic` as const;
	...
	export namespace profile {
		...
		export const disableJustMyCode =
			`${profile}.disableJustMyCode` as const;
		...
		export const showLineTickDecorationsForNode =
			`${profile}.showLineTickDecorationsForNode` as const;
	...
	export namespace decorations {
		...
		export const showFunctionStates =
			`${decorations}.showFunctionStates` as const;
		export const hideFunctionStates =
			`${decorations}.hideFunctionStates` as const;
...
export namespace contextKeys {
	...
	export const showProfileJustMyCode =
		`${extensionName}.showProfileJustMyCode` as const;
	export const showNativeCodeProfileNodes =
		`${extensionName}.showNativeCodeProfileNodes` as const;
	export const showNodeJsProfileNodes =
		`${extensionName}.showNodeJsProfileNodes` as const;
	export const showNodeModulesProfileNodes =
		`${extensionName}.showNodeModulesProfileNodes` as const;
	...
	export namespace decorations {
		...
		export const showDeopts = `${decorations}.showDeopts` as const;
		export const showICs = `${decorations}.showICs` as const;
		export const showFunctionState =
			`${decorations}.showFunctionState` as const;
		export const showProfiler = `${decorations}.showProfiler` as const;
		export const showLineTicks = `${decorations}.showLineTicks` as const;
	}
...
export enum SortDeopts {
	ByLocation = "by-location",
	ByKind = "by-kind",
	ByCount = "by-count",
}

export enum GroupDeopts {
	ByFile = "by-file",
	ByFunction = "by-function",
	ByKind = "by-kind",
}

export enum MapSortMode {
	ByName = "by-name",
	ByCount = "by-count",
}

export enum GroupMaps {
	ByFunction = "by-function",
	ByFile = "by-file",
}

export enum ShowMaps {
...
export enum ProfileSortMode {
	BySelfTime = "by-self-time",
	ByTotalTime = "by-total-time",
	ByName = "by-name",
}

export enum ProfileShowMode {
	BottomUp = "bottom-up",
	CallTree = "call-tree",
	Flat = "flat",
}

export enum ShowDecorations {
	Deopts = "deopts",
	ICs = "ics",
	Functions = "functions",
	Profiler = "profiler",
