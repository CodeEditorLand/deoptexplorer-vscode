	...
	private updateTreeViewHeader() {
		...
		const description =
			this.provider.sortBy === constants.SortDeopts.ByLocation
				...
				: this.provider.sortBy === constants.SortDeopts.ByKind
					? `By Kind/File/Function, Kind`
					: this.provider.sortBy === constants.SortDeopts.ByCount
						? `By File/Function/Kind, Count`
						: "";
