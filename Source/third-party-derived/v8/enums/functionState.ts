...
export function isCompiledFunctionState(
	value: FunctionState,
): value is FunctionState.Compiled {
	return value === FunctionState.Compiled;
}

export function isInterpretedFunctionState(
	value: FunctionState,
): value is FunctionState.Interpreted {
	return value === FunctionState.Interpreted;
}

export function isOptimizedFunctionState(
	value: FunctionState,
): value is
	| FunctionState.Optimized
