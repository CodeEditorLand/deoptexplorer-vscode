			...
			<div
				...
				<svg>
					<g
						...
						2}) translate(1, 1) scale(0.99, 0.99)">
						<circle
							fill="transparent"
							r="1"
							stroke="hsl(0, 0%, 80%)"
				...
				${cutout
					? html` <div class="pie-chart-foreground">
				...
				? html`
						<div class="pie-chart-legend">
							...
							<div class="pie-chart-legend-row">
								...
								<div
									class="pie-chart-swatch pie-chart-empty-swatch"></div>
