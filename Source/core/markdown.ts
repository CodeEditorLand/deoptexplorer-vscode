...
export namespace markdown {
	...
	export function table(
		headers: (string | MarkdownString | MarkdownTableHeader)[],
		rows: Iterable<Iterable<string | MarkdownString | MarkdownTableCell>>,
		{ html = true } = {},
	) {
	...
	export namespace table {
		export function trusted(
			headers: (string | MarkdownString | MarkdownTableHeader)[],
			rows: Iterable<
				Iterable<string | MarkdownString | MarkdownTableCell>
			>,
			{ html = true } = {},
		) {
...
function makeMarkdownCodeFactory(
	isTrusted: boolean,
	language: string | undefined,
) {
...
function makeMarkdownTable(
	...
	const markdownStringCache = new Map<
	...
	function getMarkdownString(
		...
		result =
			typeof cell === "string"
				? wrapUnsafe(cell)
				: cell instanceof MarkdownString
					? cell
					: typeof cell.text === "string"
						? wrapUnsafe(cell.text)
	...
	function getAlignment(
		...
		return (
			(typeof cell === "string" || cell instanceof MarkdownString
				? undefined
				: "align" in cell
					? cell.align
					: undefined) ?? "left"
	...
	function getOnWrite(
		...
		return typeof cell === "string" || cell instanceof MarkdownString
			? undefined
			: cell.onWrite;
	}
