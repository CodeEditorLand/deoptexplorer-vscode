...
describe("LocationMap", () => {
	...
	const loc1_sameFileAndRange = new Location(
		Uri.parse("file:///a"),
		new Range(new Position(0, 0), new Position(0, 3))
	);
	const loc1_sameFileAndStartDifferentEnd = new Location(
		Uri.parse("file:///a"),
		new Range(new Position(0, 0), new Position(0, 4))
	);
	const loc1_sameFileAndEndDifferentStart = new Location(
		Uri.parse("file:///a"),
		new Range(new Position(0, 1), new Position(0, 3))
	);
	const loc1_sameFileWithRangeCollapsedToStart = new Location(
		Uri.parse("file:///a"),
		new Position(0, 0)
	);
	const loc1_sameFileWithRangeCollapsedToEnd = new Location(
		Uri.parse("file:///a"),
		new Position(0, 3)
	);
	const loc1_sameFileAndLineWithOverlappingRange = new Location(
		Uri.parse("file:///a"),
		new Range(new Position(0, 2), new Position(0, 4))
	);
	const loc1_sameFileAndLineWithNonOverlappingRange = new Location(
		Uri.parse("file:///a"),
		new Range(new Position(0, 4), new Position(0, 6))
	);
	const loc1_sameFileDifferentLine = new Location(
		Uri.parse("file:///a"),
		new Range(new Position(1, 0), new Position(1, 3))
	);
	const loc1_differentFile = new Location(
		Uri.parse("file:///b"),
		new Range(new Position(0, 0), new Position(0, 3))
	);

	const loc2 = new Location(Uri.parse("file:///a"), new Position(0, 3));
	const loc2_sameFileAndRange = new Location(
		Uri.parse("file:///a"),
		new Position(0, 3)
	);
	const loc2_sameFileAndStartDifferentEnd = new Location(
		Uri.parse("file:///a"),
		new Range(new Position(0, 3), new Position(0, 4))
	);
	const loc2_sameFileAndEndDifferentStart = new Location(
		Uri.parse("file:///a"),
		new Range(new Position(0, 0), new Position(0, 3))
	);
	const loc2_sameFileAndLineDifferentPosition = new Location(
		Uri.parse("file:///a"),
		new Position(0, 4)
	);
	const loc2_sameFileDifferentLine = new Location(
		Uri.parse("file:///a"),
		new Position(1, 3)
	);
	const loc2_differentFile = new Location(
		Uri.parse("file:///b"),
		new Position(0, 3)
	);
	...
	describe("has()", () => {
		describe("when range is non-empty", () => {
			...
			it("returns false when location does not exist in map", () => {
				...
				expect(map.has(loc1_sameFileWithRangeCollapsedToStart)).toBe(
					false
				);
				expect(map.has(loc1_sameFileWithRangeCollapsedToEnd)).toBe(
					false
				);
				expect(map.has(loc1_sameFileAndLineWithOverlappingRange)).toBe(
					false
				);
				expect(
					map.has(loc1_sameFileAndLineWithNonOverlappingRange)
				).toBe(false);
		...
		describe("when range is empty", () => {
			...
			it("returns false when location does not exist in map", () => {
				...
				expect(map.has(loc2_sameFileAndLineDifferentPosition)).toBe(
					false
				);
	...
	describe("get()", () => {
		describe("when range is non-empty", () => {
			...
			it("returns undefined when location does not exist in map", () => {
				...
				map.set(loc1, "a");
				expect(
					map.get(loc1_sameFileAndStartDifferentEnd)
				).toBeUndefined();
				expect(
					map.get(loc1_sameFileAndEndDifferentStart)
				).toBeUndefined();
				expect(
					map.get(loc1_sameFileWithRangeCollapsedToStart)
				).toBeUndefined();
				expect(
					map.get(loc1_sameFileWithRangeCollapsedToEnd)
				).toBeUndefined();
				expect(
					map.get(loc1_sameFileAndLineWithOverlappingRange)
				).toBeUndefined();
				expect(
					map.get(loc1_sameFileAndLineWithNonOverlappingRange)
				).toBeUndefined();
			...
			it("returns correct value for various locations", () => {
				...
				expect(map.get(loc1_sameFileWithRangeCollapsedToStart)).toBe(
					"d"
				);
				expect(map.get(loc1_sameFileWithRangeCollapsedToEnd)).toBe("e");
				expect(map.get(loc1_sameFileAndLineWithOverlappingRange)).toBe(
					"f"
				);
				expect(
					map.get(loc1_sameFileAndLineWithNonOverlappingRange)
		...
		describe("when range is empty", () => {
			...
			it("returns undefined when location does not exist in map", () => {
				...
				map.set(loc2, "a");
				expect(
					map.get(loc2_sameFileAndStartDifferentEnd)
				).toBeUndefined();
				expect(
					map.get(loc2_sameFileAndEndDifferentStart)
				).toBeUndefined();
				expect(
					map.get(loc2_sameFileAndLineDifferentPosition)
				).toBeUndefined();
			...
			it("returns correct value for various locations", () => {
				...
				expect(map.get(loc2_sameFileAndLineDifferentPosition)).toBe(
					"d"
				);
