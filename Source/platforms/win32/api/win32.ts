...
import { ArrayType, type TypedArray } from "./ref-array";
import { type StructObject, StructType } from "./ref-struct";
...
export const SIZE_T = alias("SIZE_T", ULONG_PTR as ref.Type<number | bigint>) as
	| ref.Type<number>
	| ref.Type<bigint>;
